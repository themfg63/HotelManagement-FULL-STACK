...
public class JWTAuthFilter extends OncePerRequestFilter {
    ...
    token içindeki kullanıcıyı doğrular ve bu kullanıcıyı kimlik doğrulama sürecine dahil eder. Böylece, uygulama bu
    isteği yapan kişinin kimliğini doğrulamış olur ve yetkili işlemler yapmasına izin verebilir.
     */
    @Override
